...
export const defaultCompanyCommitment = (): CompanyCommitment => ({
  ...
  secondPass:0, finalPass:0, offerCount:0, placementCount:0, sales:0,
  targetRecommendations:0, targetDocumentPass:0, targetFirstPass:0,
  targetSecondPass:0, targetFinalPass:0, targetOfferCount:0, targetPlacementCount:0, targetSales:0,
  notes:'', dropRecords:[],
})
